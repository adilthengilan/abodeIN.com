...
import 'package:abodein/src/view/face_authentication.dart/authenticate_face/scanning_animation/animated_view.dart';
import 'package:abodein/src/view/face_authentication.dart/authenticate_face/user_details_view.dart';
import 'package:abodein/src/view/face_authentication.dart/common/utils/custom_snackbar.dart';
...
import 'package:abodein/src/view/face_authentication.dart/common/views/custom_button.dart';
...
// A function to calculate the Euclidean distance between two points
  ...
  _fetchUsersAndMatchFace() {
    FirebaseFirestore.instance.collection("users").get().catchError((e) {
      ...
      setState(() => isMatching = false);
      _playFailedAudio;
      CustomSnackBar.errorSnackBar(context,"Something went wrong. Please try again.");
    }).then((snap) {
                  ...
                  TextButton(
                    onPressed: () {
                      if (_nameController.text.trim().isEmpty) {
                        CustomSnackBar.errorSnackBar(context,"Enter a name to proceed");
                      } else {
