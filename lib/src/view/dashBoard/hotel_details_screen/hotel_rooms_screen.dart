import 'package:abodein/src/view/dashBoard/hotel_details_screen/booking/hotel_booking_screen.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Showing 2 of 2 rooms",
                  style: smallTextStyleblack), // AVAILABLE ROOMS COUNT
              sizedBox(height * 0.03, 0.0),
      ...
      child: Row(
        children: [
          ...
          Text("Tue, 07 May ", //-------------------------- The Date of Booking
              style: smallTextStyleblack),
          Text("-", style: smallTextStyleblack),
          sizedBox(0.0, width * 0.02),
          Icon(
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                            text: "/Night",
                            style: smallTextStyleblack), // per Night
                      ],
                    ),
                  ),
